...
| `curaops/skills/accountable-agent/` | FREEZE | B is out of scope for this step. Will be rebuilt separately. |
| `curaops/skills/accountable_agent` symlink | FREEZE | Same packaging hack. |
| `curaops/cli/commands/skills.py` (C/B sections) | FREEZE | CLI wiring for old prototype. Will be replaced per §G. |
