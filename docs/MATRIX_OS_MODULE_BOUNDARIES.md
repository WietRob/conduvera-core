...
| UI/dashboard | No | Planned PR F | Do not describe as merged runtime |
| MCP server | No | Planned PR F | Do not describe as merged runtime |
| Editor scaffolding | No | Planned PR F | Do not describe as merged runtime |
...
| Docs claim UI/MCP/editor features are merged | They are planned PR F scope |
