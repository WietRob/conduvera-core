...
| Non-Live Route-Plan Artifact Selector | Current | Select among canonical route-plan artifacts for the non-live panel without filesystem browsing or execution |
...
27. `docs/DOCUMENTATION_INVENTORY.md`
...
- PR #31 Non-Live Route-Plan Artifact Selector: canonical fixture/artifact selection for the non-live route-plan panel without arbitrary file browsing or execution
