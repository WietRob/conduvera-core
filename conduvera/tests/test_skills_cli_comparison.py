...
def test_session_manager():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            sm = AgentSessionManager(storage_dir=Path(tmpdir) / ".conduvera" / "sessions")
...
def test_multi_agent_lock():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            lock_mgr = MultiAgentLock(storage_dir=Path(tmpdir) / ".conduvera" / "locks")
...
def test_pattern_learning():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            pl = PatternLearningEngine(storage_dir=Path(tmpdir) / ".conduvera" / "patterns")
