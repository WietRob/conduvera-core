...
from conduvera.evidence.adapters.agent_evidence_plane import AGENT_EVIDENCE_PLANE_EVENT_TYPES
from conduvera.evidence.adapters.failure_loop import FAILURE_LOOP_EVENT_TYPES
from conduvera.evidence.adapters.safety_guard import SAFETY_GUARD_EVENT_TYPES
...
_ADAPTERS: tuple[AdapterDescriptor, ...] = (
    AdapterDescriptor(
        ...
        module_path="conduvera.evidence.adapters.agent_evidence_plane",
    ...
    AdapterDescriptor(
        ...
        module_path="conduvera.evidence.adapters.safety_guard",
    ...
    AdapterDescriptor(
        ...
        module_path="conduvera.evidence.adapters.failure_loop",
