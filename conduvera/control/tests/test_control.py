...
from conduvera.control.eventlog import EventLog, ControlEvent
from conduvera.control.gates import (
...
class TestScopeCheckGate:
    ...
    def test_no_scope_passes(self):
        from conduvera.control.gates import ScopeCheckGate
        gate = ScopeCheckGate()
