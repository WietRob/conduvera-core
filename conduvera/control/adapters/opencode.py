...
from conduvera.control.adapters.base import BaseAdapter, AdapterResult
...
class OpenCodeAdapter(BaseAdapter):
    ...
    def __init__(self, tmux_prefix: str = "conduvera"):
    ...
    def prepare_worktree(
        ...
        (wt / ".ready-command").write_text("conduvera-control agent ready " + agent_id)
        written.append(".ready-command")

        # .blocked-command
        (wt / ".blocked-command").write_text("conduvera-control agent blocked " + agent_id + " --reason <REASON>")
